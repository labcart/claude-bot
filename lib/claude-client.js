...
async function sendSimple(options) {
  const { message, sessionId, claudeCmd, onStream, messageContent, onToolResult, timeout = 120000, workspacePath, mcpProfile = 'no-image-tools' } = options;
  ...
  return new Promise((resolve, reject) => {
    ...
    const mcpConfigPath = generateMcpConfig(mcpProfile);
